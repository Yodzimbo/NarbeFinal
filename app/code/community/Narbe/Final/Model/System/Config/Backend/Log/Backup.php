...
class Narbe_Final_Model_System_Config_Backend_Log_Backup extends Mage_Core_Model_Config_Data {
    ...
    protected function _afterSave() {
        ...
        try {
            ...
            Mage::throwException(Mage::helper('adminhtml')->__('Nie można zapisać wyrażenia cron'));
        }
    }
